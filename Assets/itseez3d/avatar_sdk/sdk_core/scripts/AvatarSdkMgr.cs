...
namespace ItSeez3D.AvatarSdk.Core
{
	...
	public class AvatarSdkMgr
	{
		...
		/// <summary>
		/// Allows to switch between Cloud and Local Compute SDK.
		/// </summary>
		...
		/// <summary>
		/// Get current sdk type (Cloud or LocalCompute)
		/// </summary>
		...
		/// <summary>
		/// Get an instance of the IAvatarProvider implementation for the current SDK type (Cloud or LocalCompute)
		/// </summary>
        ...
        internal static string Str(object retrievngQrCode)
        {
