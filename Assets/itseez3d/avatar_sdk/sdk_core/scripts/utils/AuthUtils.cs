...
namespace ItSeez3D.AvatarSdk.Core
{
	...
	public static class AuthUtils
	{
		...
		private static AccessCredentials runtimeCredentials = null;
		...
		/// </summary>
		public static AccessCredentials LoadCredentialsFromResources()
		{
			try
			{
		...
		public static AccessCredentials LoadCredentials()
		{
			if (DeveloperSettings.ProvideCredentialsAtRuntime)
			{
				if (runtimeCredentials == null)
					Debug.LogWarning("You haven't provided credentials!");
				return runtimeCredentials;
			}
			else
			{
				return LoadCredentialsFromResources();
			}
		}

		public static void SetCredentials(string clientId, string clientSecret)
		{
			runtimeCredentials = new AccessCredentials(clientId, clientSecret);
		}
	}
}