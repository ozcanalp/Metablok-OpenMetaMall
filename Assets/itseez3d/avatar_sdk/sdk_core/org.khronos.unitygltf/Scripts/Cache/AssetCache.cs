...
namespace UnityGLTF.Cache
{
	...
	public class AssetCache : IDisposable
	{
		...
		public BufferViewCacheData[] BufferViewCache { get; private set; }
		...
		public Dictionary<string, GameObject> NodeByNameCache { get; private set; }
		...
		public AssetCache(GLTFRoot root)
		{
			...
			BufferViewCache = new BufferViewCacheData[root.BufferViews?.Count ?? 0];
			...
			NodeByNameCache = new Dictionary<string, GameObject>();
		}
		...
		public void Dispose()
		{
			...
			{
				foreach (Stream stream in ImageStreamCache)
					stream.Close();
				ImageStreamCache = null;
			}
