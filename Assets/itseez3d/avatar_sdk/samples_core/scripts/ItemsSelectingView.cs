...
namespace ItSeez3D.AvatarSdkSamples.Core
{
	...
	public class ItemsSelectingView : MonoBehaviour
	{
		...
		protected Action<List<string>, bool> closeCallback = null;
		...
		public virtual void InitItems(List<string> allItems, List<string> selectedItems)
		{
			InitItems(allItems);
		...
		/// Shows list view
		/// </summary>
		public virtual void Show(List<string> selectedItems, Action<List<string>, bool> closeAction)
		{
		...
		public void OnDoneClick()
		{
			...
			if (closeCallback != null)
				closeCallback(CurrentSelection, true);
			isShown = false;
		}
		...
		public void OnCancelClick()
		{
			itemsView.SetActive(false);
			if (closeCallback != null)
				closeCallback(defaultSelectedItems, false);
			isShown = false;
		}
