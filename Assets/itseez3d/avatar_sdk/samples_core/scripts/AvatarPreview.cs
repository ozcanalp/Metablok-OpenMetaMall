...
namespace ItSeez3D.AvatarSdkSamples.Core
{
	...
	public class AvatarPreview : MonoBehaviour
	{
		...
		public Text pipeline, code, status, progress;
		...
		{
			var loadPhoto = FileLoader.LoadAvatarFileAsync (avatarCode, AvatarFile.PHOTO);
			...
			previewTexture = ImageUtils.FixExifRotation(previewTexture, loadPhoto.Result);
		...
		public void UpdatePipelineText(string pipelineText)
		{
			pipeline.text = string.Format("Pipeline: {0}", pipelineText);
		}
