...
{
	public class SampleColorPicker : ColorPicker
	{
		public GameObject saturationValue = null;
		public GameObject saturationValueKnob = null;
		public GameObject hue = null;
		public GameObject hueKnob = null;
		public GameObject resultValue = null;
		public GameObject predefinedColors = null;

		#region IColorPicker
		public override Color Color { get { return _color; } set { Setup(value); } }

		public override void SetOnValueChangeCallback(Action<Color> onValueChange)
		{
			_onValueChange = onValueChange;
		}

		public override void SetOnResetButtonClickCallback(Action onClick)
		{
			_onResetButtonClick = onClick;
		}
		#endregion

		private Color _color = Color.red;
		private Action<Color> _onValueChange;
		private Action _onResetButtonClick;
		private Action _update;

		public void OnResetButtonClick()
		{
			if (_onResetButtonClick != null)
				_onResetButtonClick();
		}
		...
		private void Setup (Color inputColor)
		{
			...
			hueTex.Apply ();
			hue.GetComponent<Image> ().sprite = Sprite.Create (hueTex, new Rect (0, 0.5f, 1, 6), new Vector2 (0.5f, 0.5f));
			var hueSz = GetWidgetSize (hue);
			...
			var satvalSz = GetWidgetSize (saturationValue);
			...
			Action applySaturationValue = () => {
				...
				var resImg = resultValue.GetComponent<Image> ();
			...
			saturationValueKnob.transform.localPosition = new Vector2 (Saturation * satvalSz.x, Value * satvalSz.y);
		...
		void Start()
		{
			...
			{
				Button[] buttons = predefinedColors.GetComponentsInChildren<Button>();
				if (buttons != null)
				{
