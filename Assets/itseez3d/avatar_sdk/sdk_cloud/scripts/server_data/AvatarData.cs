...
namespace ItSeez3D.AvatarSdk.Cloud
{
	...
	public class AvatarData
	{
		...
		// absolute URL to retrieve available exports
		public string exports = string.Empty;

		// Export data
		public ExportData exportData = null;
		...
		public override int GetHashCode ()
		{
			...
			hashCode = hashCode * -1521134295 + EqualityComparer<string>.Default.GetHashCode (exports);
			return hashCode;
		}
	}
}